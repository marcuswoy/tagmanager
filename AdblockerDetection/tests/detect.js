window.addEventListener('load', function () {
    ...
    if (isBlockerNotChecked("adbc_")) {
        ...
        var getUrl = function (blocked, ea, cid) {
            ...
            return '/collect.php?' + "tid=" + encodeURIComponent(tid) + "&ec=" + encodeURIComponent(ec) + "&ea=" + encodeURIComponent(ea) + "&cid=" + encodeURIComponent(cid) + "&ua=" + encodeURIComponent(ua) + "&dp=" + encodeURIComponent(dp);
        };
